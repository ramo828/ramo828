...
![Profile Banner](https://raw.githubusercontent.com/ramo828/ramo828/main/assets/profile-banner.png)
...
📍 **Location**: Black Cat Emirates (Dubai vibes with a tech twist!)  
📫 **Get in Touch**:  
...
I'm super excited about diving deep into **CMake, C++, and ARM32 assembly** while crafting tools for telecom, social media automation, IoT devices, and more. As a self-taught dev, I'm all about turning ideas into code that solves real-world problems—fast, efficient, and fun!

---

## ⚡ My Skills & Tech Stack

I'm leveling up every day! Here's a breakdown of my expertise based on my projects. I've got hands-on experience across multiple languages, with Python as my go-to for quick automation wins. Percentages are estimated from my repo contributions—Python dominates because it's versatile and powerful!
...
| **Cython**    | Intermediate | High-performance tools (like numb_v2 for telecom data handling) | ~10% (Speeding up Python with C-like efficiency—game-changer!) |
| **Java**      | Beginner-Intermediate | General apps (AmonIA for AI experiments) | ~5% (Dipping into OOP for cross-platform ideas) |
| **ARM32 Assembly** | Beginner | Low-level embedded programming (exploring registers and optimizations) | Learning phase—excited to master it! |
...
## 🌟 Featured Projects: My Coding Adventures!

I've scanned my entire repo (over 20+ projects!) and hand-picked the stars—pinned ones and hidden gems alike. Each one's a story of experimentation, problem-solving, and late-night debugging. From telecom tools to AI bots and hardware hacks, here's the lineup, sorted by energy and impact. Dive in, fork, or contribute—let's collaborate! 🤝

### Pinned Highlights (My Top Picks!)
These are the projects I'm most proud of—pinned for a reason!

- **[numb_v2](https://github.com/ramo828/numb_v2)** ⭐ 2 forks  
  **Description**: A powerful tool for Bakcell and Azercell telecom ops—handle numbers, data, and more with speed!  
  **Tech**: Cython, Python  
  **Why It's Cool**: Built to automate telecom tasks efficiently. If you're into mobile data wrangling, this is your starter kit! Last updated recently—active and evolving.  
  **Status**: Production-ready, open for contributions!

- **[AmonIA](https://github.com/ramo828/AmonIA)** ⭐ 1 fork  
  **Description**: An AI-driven Java app exploring data analysis and intelligence features.  
  **Tech**: Java  
  **Why It's Cool**: My foray into AI—think smart processing and insights. Perfect for beginners wanting to tinker with Java-based ML ideas!  
  **Status**: Prototype phase, ready for expansions like integrations with Python ML libs.

- **[instagram-auto-comment](https://github.com/ramo828/instagram-auto-comment)** ⭐ 1 fork  
  **Description**: Auto-comment bot for Instagram—boost engagement effortlessly!  
  **Tech**: Python, Selenium  
  **Why It's Cool**: Automate social media interactions like a pro. Handles comments on posts dynamically—great for marketing or fun experiments.  
...
- **[instagram-comment-liker](https://github.com/ramo828/instagram-comment-liker)**  
  ...
  **Tech**: Python  
  **Why It's Cool**: Supercharge your IG presence—likes comments based on keywords or users. Ethical use only, folks!  
...
- **[python-whatsapp-automation](https://github.com/ramo828/python-whatsapp-automation)**  
  ...
  **Tech**: Python  
  **Why It's Cool**: Send messages, respond to chats—perfect for bots or productivity tools. Integrates with web WhatsApp for seamless control.  
  **Status**: Working prototype, add your twists!

### More Awesome Projects (The Full Repo Dive!)
I went through every repo—here's the complete list, grouped by theme for easy navigation. From IoT to ML on tiny devices, I've got variety!
...
- **[esp32s3-voice-asistan](https://github.com/ramo828/esp32s3-voice-asistan)**  
  ...
  **Tech**: C, ESP-IDF  
  **Why It's Cool**: Turn your ESP32 into a smart helper! Handles commands, lights, and sounds—IoT magic at its best.  
  **Stars/Forks**: 0/0 | Last Updated: Recent  
  **Status**: In development—add voice ML for next level!
...
- **[color-classification-esp32](https://github.com/ramo828/color-classification-esp32)**  
  ...
  **Tech**: C  
  **Why It's Cool**: Computer vision on a budget microcontroller. Detects colors in real-time—great for robotics or smart cams!  
...
- **[serialBoard](https://github.com/ramo828/serialBoard)**  
  ...
  **Tech**: C++  
  **Why It's Cool**: Custom input device for projects—emulates keyboards over USB/serial. DIY hardware fun!  
  **Stars/Forks**: 0/0 | Last Updated: Recent  
...
- **[picoTempSensor](https://github.com/ramo828/picoTempSensor)**  
  ...
  **Tech**: C  
  **Why It's Cool**: Monitors env temps with simple sensors—IoT starter for monitoring systems.  
...
- **[pico-tensorflow](https://github.com/ramo828/pico-tensorflow)**  
  ...
  **Tech**: C++  
  **Why It's Cool**: Run AI models on tiny hardware! Edge computing at its finest—classify images or predict data on the go.  
  **Stars/Forks**: 0/0 | Last Updated: Older  
...
- **[vpn-bot](https://github.com/ramo828/vpn-bot)**  
  ...
  **Tech**: Python  
  **Why It's Cool**: Automate VPN setup, switching—secure your connections with ease!  
  **Stars/Forks**: 0/0 | Last Updated: Recent  
...
- **[3d_printer_calibration](https://github.com/ramo828/3d_printer_calibration)**  
  ...
  **Tech**: Python (likely)  
  **Why It's Cool**: Fine-tune your prints for perfection—mechanical engineering meets code!  
  **Stars/Forks**: 0/0 | Last Updated: Older  
  **Status**: Utility script, handy for makers.

And that's the full scoop—over 15 repos in total, with more brewing! Check out [all my repositories](https://github.com/ramo828?tab=repositories) for the complete list. If a project sparks your interest, star it, fork it, or PR your ideas!

---

## 📈 My GitHub Stats: Numbers Don't Lie!
...
Consistent commits? Check! Growing contributions? Absolutely—watch this space explode!

---

## 🎯 My Goals & What's Next
- Master **ARM32 assembly** for ultra-low-level optimizations in embedded tech.
- Build more **IoT projects** with ESP32/Raspberry Pi—smart homes, here I come!
- Expand automation bots to include AI (like ChatGPT integrations).
- Land a dev role blending mechanical engineering with software—dream big!

As a mechanical engineer, I love bridging hardware and code. Chemistry? That's for explosive ideas! Electronics? Wiring up the future. Join me on this journey—let's code, create, and conquer! 🔥

---

## 🤝 Join the Adventure!
Got a collab idea? Need help with a bot or embedded project? Hit me up—I'm always online and ready to brainstorm. Together, we can turn code into chaos (the good kind)!
...
*"Code like there's no tomorrow—because innovation waits for no one!"*  
© 2025 Ramiz Mammadli | Powered by Passion & Python 🚀
