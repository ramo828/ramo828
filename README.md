# Hey, I'm Ramiz Mammadli 👋

<img src="https://raw.githubusercontent.com/ramo828/ramo828/main/banner-logo.jpg" alt="Banner" width="100%"/>
...
📍 Based in the UAE (Black Cat Emirates)  
🔧 Turning hardware ideas into working code
...
| Project | Description | Tech |
|---------|-------------|------|
| [**numb_v2**](https://github.com/ramo828/numb_v2) | High-performance telecom tool for Bakcell / Azercell / Nar (Cython + C++) | Cython, C++, Python |
| [**numb_v4**](https://github.com/ramo828/numb_v4) | Newer version of the number management tool | Dart |
| [**NotePadAPI**](https://github.com/ramo828/NotePadAPI) | API-based notepad service | Python |
| [**rust-proxy-server**](https://github.com/ramo828/rust-proxy-server) | Lightweight proxy server | Rust |
...
- Continuous focus on embedded systems, automation and education
...
<p align="center">
  <i>"I teach what I build, and I build what I teach."</i>
</p>

<p align="center">
  <b>Ramiz Mammadli</b> · Mechanical Engineer · Embedded Developer · Mentor<br>
  © 2026
</p>
